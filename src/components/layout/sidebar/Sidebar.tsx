...
const Sidebar: React.FC<SidebarProps> = ({ }) => {
  return (
    <div className="flex h-screen bg-gray-100 font-inter"> {/* Assurez-vous que 'font-inter' est défini via Tailwind */}
      {/* Sidebar */}
      <aside className="w-64 bg-indigo-600 text-white flex flex-col rounded-r-lg shadow-lg"> {/* Ajout de rounded-r-lg et shadow-lg pour le style */}
        ...
        {/* <div className="mt-auto p-4 border-t border-gray-800">
          <div className="flex items-center">
            <Image className="h-8 w-8 rounded-full" src="/images/user/user-01.png" alt="User profile" width={32} height={32} />
            <div className="ml-3">
