...
// Définition d'un type pour les props des icônes SVG
export type IconProps = SVGProps<SVGSVGElement>;

// Icône de tableau de bord (Home)
export function DashboardIcon(props: IconProps) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M9 17.25a.75.75 0 000 1.5h6a.75.75 0 000-1.5H9z" fill="currentColor" />
...
// Icône d'utilisateurs (User Group)
...
// Icône de paramètres (Cog)
export function SettingsIcon(props: IconProps) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path fillRule="evenodd" clipRule="evenodd"
        d="M12 2.25c-1.06 0-2.07.24-3.003.702-.91.45-1.745 1.07-2.485 1.81S3.25 5.92 2.8 6.833C2.33 7.765 2.09 8.775 2.09 9.833c0 1.058.24 2.068.702 3.001.45.91 1.07 1.745 1.81 2.485s1.575 1.36 2.485 1.81c.933.462 1.943.702 3.001.702 1.06 0 2.07-.24 3.003-.702.91-.45 1.745-1.07 2.485-1.81s1.36-1.575 1.81-2.485c.462-.933.702-1.943.702-3.001 0-1.058-.24-2.068-.702-3.001-.45-.91-1.07-1.745-1.81-2.485s-1.575-1.36-2.485-1.81C14.07 2.49 13.06 2.25 12 2.25zM12 16.25a4.25 4.25 0 100-8.5 4.25 4.25 0 000 8.5zM12 14.75a2.75 2.75 0 110-5.5 2.75 2.75 0 010 5.5z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path fillRule="evenodd" clipRule="evenodd"
        ...
        fill="currentColor"
      />
      <path d="M2.001 11.249a.75.75 0 000 1.5h11.973l-1.961 1.68a.75.75 0 10.976 1.14l3.5-3a.75.75 0 000-1.14l-3.5-3a.75.75 0 00-.976 1.14l1.96 1.68H2.002z" fill="currentColor" />
    </svg>
  );
}

// Icône de profil (User)
...
// Icône de flèche vers le bas (pour les dropdowns)
...
// Icône de fermeture (X) pour mobile
