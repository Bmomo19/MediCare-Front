...
import { useAuth } from '../../contexts/AuthContext'; // Ajuster le chemin d'import

// Pour un titre spécifique à la page, on utilise un export `metadata`
...
const LoginPage: React.FC = () => {
  ...
  return (
    // <> // Pas besoin de fragment ici, car le layout englobera déjà
      <div className="min-h-screen flex items-center justify-center bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-white p-8 rounded-xl shadow-2xl w-full max-w-md z-10 transform transition-all duration-300 hover:scale-105">
          <div className="text-center mb-8">
            <div className="mx-auto h-16 w-16 text-indigo-600">
